 ...
 * 
 * Each vehicle should have a method called toString, which returns
 * a string containing the make, model, and year.
 */
...
/** Part Four
 * Create a class called Garage. It should have a property called vehicles
 * which will store an array of vehicles, and a property called capacity
 * which is a number indicating how many vehicles can fit in the garage.
 ...
 * allowed in here!". Also if the garage is at capacity, it should say 
 * "Sorry, we're full."
 */
